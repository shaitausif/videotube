// This hook is responsible for listening and acting upon the foreground message events and also for assigning or updating registration tokens whenever the user:  
/*
- Initilize the app 
- Change the message permission 
- Subsequen app starts
- on logout
- After a month because usually the fcm generated tokens get expired in a month
  ...
  useEffect(() => {
    const setupListener = async () => {
      ...
      const unsubscribe = onMessage(m, (payload) => {
        ...
        // We can get this payload from the firebase admin SDK which we had setted up in send-notification/route.ts or from the console GUI provided by the firebase
