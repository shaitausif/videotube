...
const page = () => {
  ...
  const onSubmit = async(data: z.infer<typeof SignupSchema>) => {
    try {
      ...
      if(!data.avatar || !data.email || !data.fullName || !data.username || !data.password){
      ...
      console.log(res)
      toast(`Unable to register the User ${res.message}`)
              ...
              <Form {...form}>
                ...
                >
                  ...
                  <div className="flex-1 space-y-6">
                    ...
                    <Button type="submit" className="md:mt-4 w-full">
                      Submit
                    </Button>
                  </div>
                </form>
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <span className="h-px flex-1 bg-gray-300"></span>
                  ...
                  <div className="flex flex-col gap-3  justify-center items-center">
                    <div>
                      <button onClick={() => signIn('google',{callbackUrl : "/"})} className="flex items-center w-64 bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
            <svg
            ...
            <span>Continue with Google</span>
              ...
              <div>
                  <button onClick={()=>{signIn("github",{callbackUrl : '/'})}} className="flex items-center w-64 bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
            <svg
              className="h-6 w-6 mr-2"
              xmlns="http://www.w3.org/2000/svg"
              xmlnsXlink="http://www.w3.org/1999/xlink"
